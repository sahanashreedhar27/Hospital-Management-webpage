...
%>
<!DOCTYPE html>
<center><h2 class="color-me1" >NURSE</h2></center> 
...
String sql ="select n.nurse_id,n.name,d.name,n.phone_no from doctors d,nurse n where n.doctor_id=d.doctor_id and d.specialization like '"+val+"';";
...
<tr >
<b><td  style="font-weight:bold" bgcolor="#000000">NURSE_ID</td></b>
<b><td style="font-weight:bold" bgcolor="#000000">NAME</td></b>
<b><td style="font-weight:bold" bgcolor="#000000">SUPERVISED BY</td></b>
<b><td style="font-weight:bold" bgcolor="#000000">PHONE NO</td></b>
</tr>
<%}%>
<tr>
<td><%=resultSet.getString("n.nurse_id") %></td>
<td><%=resultSet.getString("n.name") %></td>
<td><%=resultSet.getString("d.name") %></td>
<td><%=resultSet.getString("n.phone_no") %></td>
</tr>
<%
}
//connection.close();
