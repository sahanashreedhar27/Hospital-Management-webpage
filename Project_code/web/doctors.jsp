...
%>
<!DOCTYPE html>
<center><h2 class="color-me1" >DOCTORS</h2></center> 
<center><form action="doctors.jsp" method="POST">
    <select name="value" >      
...
String sql ="select * from doctors where specialization like '"+val+"';";
...
<tr >
<b><td  style="font-weight:bold" bgcolor="#000000">DOCTOR_ID</td></b>
<b><td style="font-weight:bold" bgcolor="#000000">NAME</td></b>
<b><td style="font-weight:bold" bgcolor="#000000">SPECIALIZATION</td></b>
